...
class FormularioCita extends Component
{
    ...
    public function mount()
    {
        ...
        $this->selected_date = Carbon::now('America/Mazatlan')->format('Y-m-d');  
    }
    ...
    public function render()
    {
        ...
        $this->appointments_hour = Appointment::select(DB::raw("DATE_FORMAT(hour, '%H:%i') as hour"))->where('date', $this->selected_date)->get();
        ...
        return view('livewire.formulario-cita', compact('avaliable_hours' ,'diference_hours'));
    }
