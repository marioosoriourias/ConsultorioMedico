<div>
    <div class="container">
        <h1 class="text-3xl text-center pb-8 pt-2">Citas asignadas a  {{$medic->name}}</h1>
                        ...
                        @foreach ($appointments as $appoinment)
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">    
                                    ...
                                    <div class="ml-4">
                                        <div class="text-base font-medium text-gray-900">
                                            <a href="{{route('medics.show', $medic)}}">{{$appoinment->patient->name}}</a>
                                        </div>
                                    </div>
                                    </div>
                                </td>
                                ...
                                <td  class="px-6 py-4 whitespace-pre-line">
                                    <div class="text-sm text-gray-900">{{$appoinment->observations}}</div>                   
                                </td>

                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{$appoinment->date}}</div>                   
                                </td>

                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <div class="text-sm text-gray-900">{{$appoinment->hour}}</div>      
                                </td>                                                    
