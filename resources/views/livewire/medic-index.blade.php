<div>
    <div class="container">
        <h1 class="text-3xl text-center pb-8 pt-2">Médicos</h1>
        ...
        <x-table-responsive>
            <div class="px-6 py-4 flex ">
                ...
                <a href="{{route('medics.create')}}" class="btn btn-danger ml-2">Agregar nuevo médico</a>
            </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($medics as $medic)
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">    
                                    ...
                                    <div class="ml-4">
                                        <div class="text-base font-medium text-gray-900">
                                            <a href="{{route('medics.show', $medic)}}">{{$medic->name}}</a>
                                        </div>
                                    </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{$medic->age}}</div>                   
                                </td>

                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{$medic->gender}}</div>                   
                                </td>

                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <div class="text-sm text-gray-900">{{$medic->email}}</div>      
                                </td>                                                    
